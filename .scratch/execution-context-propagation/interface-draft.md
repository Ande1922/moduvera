...
| [TrustedJwtPrincipal](../../framework/starters/moduvera-auth-resource-server-autoconfigure/src/main/java/io/github/ande1922/moduvera/security/jwt/TrustedJwtPrincipal.java) 第 18 行；历史基线 `ce1636f82f9652b2b14dd9e146e62c748fbf3233` 的 `framework/starters/moduvera-auth-resource-server-autoconfigure/src/main/java/io/github/ande1922/moduvera/security/web/ExecutionContextFilter.java` 第 39 行 | USER 认证映射与 TENANT 入口要求解耦；修改相应认证/入口测试 |
