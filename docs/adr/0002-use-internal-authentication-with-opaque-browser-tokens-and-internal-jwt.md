...
ADR 0035 supersedes this product-wide ownership decision. The opaque-session and internal-JWT flow remains a reference-product implementation, not a required scaffold IAM architecture.
